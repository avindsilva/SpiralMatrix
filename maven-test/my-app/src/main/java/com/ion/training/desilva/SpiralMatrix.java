...
public class SpiralMatrix {
    ...
    public void printSpiral() {
        ...
        try {
            writer = new PrintWriter("array.json", "UTF-8");
    ...
    void printArray() {
        JSONArray parentJsonArray = new JSONArray();    //Object for writing json equivalent of the matrix
        for (int i = 0; i < this.order; i++) {
            JSONArray childJsonArray = new JSONArray();
            for (int j = 0; j < this.order; j++) {
                //System.out.print(array[i][j] + " ");
                System.out.format("%02d ", array[i][j]);
                childJsonArray.add(new Integer(array[i][j]));
            }
            System.out.println("");
        ...
        writer.append(parentJsonArray.toString());
        writer.println();
        System.out.println(parentJsonArray.toJSONString());
        System.out.println("");
